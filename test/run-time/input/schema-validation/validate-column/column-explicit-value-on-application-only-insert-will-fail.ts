...
tape(__filename, async (t) => {
    ...
    await pool.acquire(async (connection) => {
        ...
        t.deepEqual(
            result.errors[0],
            {
                type : tsql.SchemaValidationErrorType.COLUMN_EXPLICIT_DEFAULT_VALUE_ON_APPLICATION_ONLY_INSERT_WILL_FAIL,
                description : `Column "test"."testVal2" has explicit default value on application only; INSERTs will fail`,
                tableAlias : "test",
