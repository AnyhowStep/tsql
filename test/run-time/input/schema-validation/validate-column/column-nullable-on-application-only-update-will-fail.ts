...
tape(__filename, async (t) => {
    ...
    await pool.acquire(async (connection) => {
        ...
        t.deepEqual(
            result.errors[0],
            {
                type : tsql.SchemaValidationErrorType.COLUMN_NULLABLE_ON_APPLICATION_ONLY_UPDATE_WILL_FAIL,
                description : `Column "test"."testVal" is nullable on application only; UPDATEs using NULL value will fail`,
                tableAlias : "test",
                columnAlias : "testVal",
            }
        );
