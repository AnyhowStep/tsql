...
tape(__filename, t => {
    ...
    t.deepEqual(
        ...
        `COALESCE("myTable"."myColumn" + "myTable"."myColumn" + "myTable"."myColumn" + "myTable"."myColumn" + "myTable"."myColumn" + "myTable"."myColumn" + "myTable"."myColumn" + "myTable"."myColumn" + "myTable"."myColumn" + "myTable"."myColumn" + "myTable"."myColumn" + "myTable"."myColumn" + "myTable"."myColumn", ${THROW_AST})`
    );
