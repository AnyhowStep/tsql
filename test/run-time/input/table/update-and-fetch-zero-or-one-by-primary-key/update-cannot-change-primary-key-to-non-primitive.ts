...
tape(__filename, async (t) => {
    ...
    await pool.acquire(async (connection) => {
        ...
        return dst.updateAndFetchZeroOrOneByPrimaryKey(
            connection,
            {
                testId : BigInt(1),
            },
            ...
            t.fail("Should not be able to update primary key to non-primitive");
        }).catch(() => {
            t.pass("Cannot update primary key to non-primitive");
        });
    });
