...
export function innerJoinNoOuterQueryReference<
    ...
    RawOnClauseT extends tsql.BuiltInExpr_NonAggregate<boolean>
> (
    ...
    return tsql.FromClauseUtil.innerJoin<
        FromClauseT,
        AliasedTableT,
        (
            & RawOnClauseT
...
innerJoinNoOuterQueryReference(
...
export const fromClause = innerJoinNoOuterQueryReference(
    tsql.FromClauseUtil.from(
        tsql.FromClauseUtil.requireOuterQueryJoins(
            tsql.FromClauseUtil.newInstance(),
            outerQueryTable
