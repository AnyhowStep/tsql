...
export const query = tsql.QueryUtil.newInstance()
    .from(myTable)
    .innerJoinUsingCandidateKey(tables => tables.myTable, myOtherTable1, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable1, myOtherTable2, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable2, myOtherTable3, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable3, myOtherTable4, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable4, myOtherTable5, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable5, myOtherTable6, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable6, myOtherTable7, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable7, myOtherTable8, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable8, myOtherTable9, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable9, myOtherTable10, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable10, myOtherTable11, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable11, myOtherTable12, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable12, myOtherTable13, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable13, myOtherTable14, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable14, myOtherTable15, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable15, myOtherTable16, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable16, myOtherTable17, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable17, myOtherTable18, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable18, myOtherTable19, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable19, myOtherTable20, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable20, myOtherTable21, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable21, myOtherTable22, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable22, myOtherTable23, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable23, myOtherTable24, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable24, myOtherTable25, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable25, myOtherTable26, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable26, myOtherTable27, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable27, myOtherTable28, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable28, myOtherTable29, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable29, myOtherTable30, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable30, myOtherTable31, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable31, myOtherTable32, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable32, myOtherTable33, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable33, myOtherTable34, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable34, myOtherTable35, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable35, myOtherTable36, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable36, myOtherTable37, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable37, myOtherTable38, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable38, myOtherTable39, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable39, myOtherTable40, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable40, myOtherTable41, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable41, myOtherTable42, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable42, myOtherTable43, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable43, myOtherTable44, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable44, myOtherTable45, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable45, myOtherTable46, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable46, myOtherTable47, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable47, myOtherTable48, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable48, myOtherTable49, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable49, myOtherTable50, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable50, myOtherTable51, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable51, myOtherTable52, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable52, myOtherTable53, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable53, myOtherTable54, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable54, myOtherTable55, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable55, myOtherTable56, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable56, myOtherTable57, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable57, myOtherTable58, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable58, myOtherTable59, columns => [columns.x])
    .innerJoinUsingCandidateKey(tables => tables.myOtherTable59, myOtherTable60, columns => [columns.x]);
