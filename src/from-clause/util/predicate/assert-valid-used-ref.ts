...
/**
 * @todo `usedRef` is supposed to be contravariant!
 */
type AllowedColumns<
...
> = (
    ...
    | (
        ...
        ColumnUtil.FromJoinArray<FromClauseT["parentJoins"]> :
        never
    )
    /**
...
export function assertValidUsedRef (
    ...
    const allowedFromParentQuery = (
        query.parentJoins == undefined ?
        {} :
        ColumnIdentifierRefUtil.fromJoinArray(query.parentJoins)
    );
