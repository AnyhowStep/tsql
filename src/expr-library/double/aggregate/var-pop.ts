 ...
 */
export const varPop : AggregateOperator1<number|null, number|null> = makeAggregateOperator1<OperatorType.AGGREGATE_POPULATION_VARIANCE, number|null, number|null>(
