 ...
 * PostgreSQL has no concept of `UNSIGNED BIGINT`; this is subtracting two `DECIMAL`s.
 * SQLite has no concept of `UNSIGNED BIGINT`; this is subtracting two `DOUBLE`s.
 *
 * -----
 *
