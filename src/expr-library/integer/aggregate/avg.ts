 ...
 */
const avgImpl = makeAggregateOperator2<OperatorType.AGGREGATE_AVERAGE, boolean, bigint, Decimal|null>(
    OperatorType.AGGREGATE_AVERAGE,
    decimalMapper.orNull(),
    TypeHint.BIGINT_SIGNED
);

export const avgDistinct : AggregateOperator1<bigint, Decimal|null> = <
...
export const avgAll : AggregateOperator1<bigint, Decimal|null> = <
    ArgT extends BuiltInExpr_NonAggregate<bigint>
>(
    arg : ArgT
) : (
