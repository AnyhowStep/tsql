[![Build Status](https://travis-ci.org/AnyhowStep/tsql.svg?branch=master)](https://travis-ci.org/AnyhowStep/tsql) [![codecov](https://codecov.io/gh/AnyhowStep/tsql/branch/master/graph/badge.svg)](https://codecov.io/gh/AnyhowStep/tsql) [![HitCount](http://hits.dwyl.io/AnyhowStep/tsql.svg)](http://hits.dwyl.io/AnyhowStep/tsql) [![Known Vulnerabilities](https://snyk.io/test/github/AnyhowStep/tsql/badge.svg?targetFile=package.json)](https://snyk.io/test/github/AnyhowStep/tsql?targetFile=package.json)
