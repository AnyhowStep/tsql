...
export const test : Test = ({tape, pool}) => {
    tape(__filename, async (t) => {
        await pool.acquire(async (connection) => {
             ...
             */
            await tsql.selectValue(() => tsql.integer.sub(BigInt("-9223372036854775808"), BigInt(1)))
             ...
             */
            await tsql.selectValue(() => tsql.integer.sub(BigInt("9223372036854775807"), BigInt(1)))
                .fetchValue(connection)
                .then((value) => {
