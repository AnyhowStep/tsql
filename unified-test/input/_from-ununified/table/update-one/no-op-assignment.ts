...
export const test : Test = ({tape, pool, createTemporarySchema}) => {
    tape(__filename, async (t) => {
         ...
         *
         * MySQL will return zero, because it is a no-op assignment.
         */
        t.true(
            tm.BigIntUtil.equal(result.updatedRowCount, BigInt(0)) ||
            tm.BigIntUtil.equal(result.updatedRowCount, BigInt(1))
        );
        t.deepEqual(
            result.warningCount,
            BigInt(0)
